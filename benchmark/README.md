...
All nineteen are covered by the insecure/secure self-test above (100% / 0%). The
matched-model numbers reported here predate the classes added after
SQLi/IDOR/mass-assignment; those newer classes are harness-verified and awaiting
